...
import { BarChart3, Bell, Calendar, CalendarPlus, CreditCard, DollarSign, Home, Images, Lightbulb, LogOut, Menu, Plus, Scissors, Settings, ShieldAlert, ShieldCheck, Sparkles, Ticket, UserCog, Users, X } from 'lucide-react';
